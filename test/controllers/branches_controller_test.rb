...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { address: @branch.address, contact: @branch.contact, lat: @branch.lat, lng: @branch.lng, name: @branch.name }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { address: @branch.address, contact: @branch.contact, lat: @branch.lat, lng: @branch.lng, name: @branch.name }
    assert_redirected_to branch_path(assigns(:branch))
  end
